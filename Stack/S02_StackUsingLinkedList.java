...
class S02_StackUsingLinkedList {

	/* declaring node */
	static Node root;
	/* defining node as null upon creation of the object. */
	S02_StackUsingLinkedList() {
		root = null;
	}
	...
	/* While pushing the key into stack, we'll check if stack is empty or not. */
	void push(int key) {
	...
	*/
	...
	public static void main(String[] args) {
		S02_StackUsingLinkedList stack = new S02_StackUsingLinkedList();
		stack.push(10);
		stack.push(20);
		stack.push(30);
